    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(addmedicine.this, "Reminder set for "+dateTV.getText().toString()+" time "+timeTV.getText().toString(), Toast.LENGTH_SHORT).show();
        ...
        addMeeting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(t.equals("")||du.equals("")||d.equals("")||time.equals("")){
                    ...
                    Toast.makeText(addmedicine.this, "Please fill all details!!", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    if(insert == true){
                        ...
                        if(insertData==true){
                            Toast.makeText(addmedicine.this, "Successfully added!", Toast.LENGTH_SHORT).show();
                            Intent i=new Intent(addmedicine.this,viewcheckup.class);
                            i.putExtra("topic",t);
                            ...
                            Toast.makeText(addmedicine.this, "Couldn't add.", Toast.LENGTH_SHORT).show();
                        }
                    }else {
                       Toast.makeText(addmedicine.this, "Time already exists, Please choose some other time", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
